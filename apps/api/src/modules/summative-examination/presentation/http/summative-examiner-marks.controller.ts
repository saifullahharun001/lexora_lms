...
@Controller({
  path: "summative/examination-courses/:examinationCourseId/marking-workspace",
  version: "1",
})
@UseGuards(AuthGuard, PolicyGuard)
@RequirePolicy(SUMMATIVE_EXAMINATION_POLICY_NAMES.EXAMINER_MARKS_ENTER)
export class SummativeExaminerMarksController {
  constructor(private readonly service: SummativeExaminerMarksService) {}
