  ...
  return (
    <div className={cn("min-h-screen bg-transparent text-slate-900", className)}>
      <div className="mx-auto grid min-h-screen max-w-7xl min-w-0 gap-6 px-4 py-6 lg:grid-cols-[280px_minmax(0,1fr)] lg:px-6">
        <aside className="rounded-3xl border border-white/50 bg-white/82 p-5 shadow-xl shadow-stone-950/18 backdrop-blur-xl">
        ...
        <main className="min-w-0 rounded-3xl border border-white/65 bg-white/94 p-6 shadow-xl shadow-stone-950/16 backdrop-blur-md">
          {children}
        </main>
      </div>
    </div>
